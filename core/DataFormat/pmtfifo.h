...
namespace larlite {
  ...
  */
  ...
  public:
    ...
    pmtfifo(UShort_t ch,
	    ...
	    UChar_t  module_id,
	    fem::Discriminator_t disc,
	    //data::DataType_t type,
	    std::vector<unsigned short> wf) : fifo::fifo(ch,
							 frame,
							 sample,
							 module_address,
							 module_id,
  ...
  protected:
    ...
    fem::Discriminator_t _disc_id; ///< Discriminator ID 
  ...
  */
  class event_pmtfifo : public std::vector<larlite::pmtfifo>, public event_base {
  ...
  public:
    ...
    event_pmtfifo(const event_pmtfifo& original)
      : std::vector<larlite::pmtfifo>(original),
      event_base(original),
