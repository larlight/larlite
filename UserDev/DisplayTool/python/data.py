...
class drawableItems(object):
    ...
    def __init__(self):
        ...
        self._drawableClasses.update({'Hit': [hit,"hit"]})
        self._drawableClasses.update({'Cluster': [cluster,"cluster"]})
        self._drawableClasses.update({'Match': [match,"cluster"]})
        self._drawableClasses.update({'Shower': [shower,"shower"]})
        self._drawableClasses.update({'Track': [track,"track"]})
