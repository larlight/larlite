...
// bool DrawUbDaq::analyze(larlite::storage_manager* storage) {
...
void DrawUbDaq::SetStepSizeByPlane(int step, int plane) {
...
float DrawUbDaq::getCorrelation(const std::vector<float> & vec1, const std::vector<float> & vec2)
{
...
float DrawUbDaq::getMedian(std::vector<float> & vals) {
