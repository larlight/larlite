#ifndef LARLITE_MC_NC_OTHER_FILTER_CXX
#define LARLITE_MC_NC_OTHER_FILTER_CXX

#include "MC_NC_other_Filter.h"

namespace larlite {

  bool MC_NC_other_Filter::initialize() {
  ...
  bool MC_NC_other_Filter::analyze(storage_manager* storage) {
  ...
  bool MC_NC_other_Filter::finalize() {
