#ifndef LARLITE_MC_NC_CHARGEDPION_FILTER_CXX
#define LARLITE_MC_NC_CHARGEDPION_FILTER_CXX

#include "MC_NC_chargedpion_Filter.h"

namespace larlite {

  bool MC_NC_chargedpion_Filter::initialize() {
  ...
  bool MC_NC_chargedpion_Filter::analyze(storage_manager* storage) {
  ...
  bool MC_NC_chargedpion_Filter::finalize() {
