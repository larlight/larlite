#ifndef LARLITE_MC_NC_GAMMA_FILTER_CXX
#define LARLITE_MC_NC_GAMMA_FILTER_CXX

#include "MC_NC_gamma_Filter.h"

namespace larlite {

  bool MC_NC_gamma_Filter::initialize() {
  ...
  bool MC_NC_gamma_Filter::analyze(storage_manager* storage) {
  ...
  bool MC_NC_gamma_Filter::finalize() {
