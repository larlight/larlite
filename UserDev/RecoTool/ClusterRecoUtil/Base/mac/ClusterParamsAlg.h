...
namespace cluster {
  ...
  public:
    ...
    /// Alternative constructor with Hit2D vector
    ClusterParamsAlg(const std::vector<Hit2D>&);
    ...
    */
    ...
    const std::vector<Hit2D>& GetHitVector() const {return fHitVector;}
