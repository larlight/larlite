/**
 * \file CBAlgoVtxAlign2.h
 *
 * \ingroup CMTool
 * 
 * \brief Class def header for a class CBAlgoVtxAlign2
 *
...
/** \addtogroup CMTool
    ...
    @{*/
#ifndef RECOTOOL_CBALGOVTXALIGN2_H
#define RECOTOOL_CBALGOVTXALIGN2_H
...
namespace cmtool {
  ...
  */
  class CBAlgoVtxAlign2 : public CBoolAlgoBase {
