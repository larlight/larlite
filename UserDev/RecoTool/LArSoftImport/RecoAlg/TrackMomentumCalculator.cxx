...
namespace trkf{ 
  ...
  Double_t TrackMomentumCalculator::GetMomentumMultiScatterLLHD( const ::geoalgo::Trajectory &trk )
  {
    
    std::vector<Float_t> recoX; std::vector<Float_t> recoY; std::vector<Float_t> recoZ;
    
    recoX.clear(); recoY.clear(); recoZ.clear();
    recoX.reserve(trk.size());
    recoY.reserve(trk.size());
    recoZ.reserve(trk.size());
	...
	recoX.push_back( trk[i][0] ); recoY.push_back( trk[i][1] ); recoZ.push_back( trk[i][2] ); 
	
      }

    return GetMomentumMultiScatterLLHD(recoX,recoY,recoZ);
  }

  Double_t TrackMomentumCalculator::GetMomentumMultiScatterLLHD( const std::vector<Float_t>& recoX,
								 const std::vector<Float_t>& recoY,
								 const std::vector<Float_t>& recoZ )
  {
    Double_t p = -1.0; 
  ...
  Double_t TrackMomentumCalculator::GetMuMultiScatterLLHD( const ::geoalgo::Trajectory &trk )
  {
    ...
    return GetMuMultiScatterLLHD(recoX,recoY,recoZ);
  }
  
  Double_t TrackMomentumCalculator::GetMuMultiScatterLLHD( const std::vector<Float_t>& recoX,
							   const std::vector<Float_t>& recoY,
							   const std::vector<Float_t>& recoZ )
  {
    Double_t LLHD = -1.0; 
  ...
  Double_t TrackMomentumCalculator::GetMuMultiScatterLLHD2( const ::geoalgo::Trajectory& trk )
  {
    ...
    return GetMuMultiScatterLLHD2(recoX,recoY,recoZ);
  }

  Double_t TrackMomentumCalculator::GetMuMultiScatterLLHD2( const std::vector<Float_t>& recoX,
							    const std::vector<Float_t>& recoY,
							    const std::vector<Float_t>& recoZ )
  {
    Double_t LLHD = -1.0; 
  ...
  Int_t TrackMomentumCalculator::GetDeltaThetaij( std::vector<Float_t> &ei,
  ...
  Double_t TrackMomentumCalculator::GetMomentumMultiScatterChi2( const ::geoalgo::Trajectory &trk )
  {
    ...
    return GetMomentumMultiScatterChi2(recoX,recoY,recoZ);
  }

  Double_t TrackMomentumCalculator::GetMomentumMultiScatterChi2( const std::vector<Float_t>& recoX,
								 const std::vector<Float_t>& recoY,
								 const std::vector<Float_t>& recoZ )
  {
    Double_t p = -1.0; 
    ...
    /*
    gr_meas = TGraphErrors( nmeas, xmeas, ymeas, 0, eymeas );
