...
bool ShowerQuality_nueshowers::analyze(storage_manager* storage) {
  ...
  for(const auto& mcs : *ev_mcs) {
    if (mcs.PdgCode() == 11) {
      // std::cout << mcs.PdgCode() << std::endl;
      // std::cout << mcs.TrackID() << std::endl;
      // std::cout << mcs.Process() << std::endl;
      // std::cout << "MOM"<< std::endl;
      // std::cout << mcs.MotherPdgCode() << std::endl;
      // std::cout << mcs.MotherTrackID() << std::endl;
      // std::cout << mcs.MotherProcess() << std::endl;
      // std::cout << "ANC"<< std::endl;
      // std::cout << mcs.AncestorPdgCode() << std::endl;
      // std::cout << mcs.AncestorTrackID() << std::endl;
      // std::cout << mcs.AncestorProcess() << std::endl;
...
void ShowerQuality_nueshowers::FillQualityInfo(const shower& reco_shower, const mcshower& mc_shower, size_t shower_index)// const std::vector< const larlite::cluster * > associated_clusters)
{
