#ifndef PROTOSHOWERALGCMTOOL_CXX
#define PROTOSHOWERALGCMTOOL_CXX

#include "ProtoShowerAlgCMTool.h"
...
namespace protoshower {
  ...
  ProtoShowerAlgCMTool::ProtoShowerAlgCMTool()
    : _params_alg(nullptr)
  {
    ...
    _name = "ProtoShowerAlgCMTool";
  }

  void ProtoShowerAlgCMTool::GenerateProtoShower(::larlite::storage_manager* storage,
						 ...
						 protoshower::ProtoShower & proto_shower)
  {
	...
	for (size_t i = 0; i < cluster_v.size(); i++) {
	  ...
	  // now fill quantities specifically to LArCMTool
