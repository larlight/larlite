...
namespace showerreco{
  ...
  void Angle3DFormula::do_reconstruction(const ShowerClusterSet_t& inputShowers,
    ...
    for (size_t i=0; i < inputShowers.size(); i++){
      for (size_t j=i+1; j < inputShowers.size(); j++){
	
	auto const& cl1 = inputShowers[i];
	auto const& cl2 = inputShowers[j];
