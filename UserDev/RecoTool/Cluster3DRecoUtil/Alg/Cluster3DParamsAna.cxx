#ifndef LARLITE_CLUSTER3DPARAMSANA_CXX
#define LARLITE_CLUSTER3DPARAMSANA_CXX

#include "Cluster3DParamsAna.h"
#include "CRU3DHelper.h"
// #include "DataFormat/mcshower.h"

namespace cluster3D {

Cluster3DParamsAna::Cluster3DParamsAna()
    : _param_tree(nullptr)
{
    _fout = 0;
    _name = "Cluster3DParamsAna";
    _verbose = false;
}

bool Cluster3DParamsAna::initialize() {
/*
...
bool Cluster3DParamsAna::analyze(::larlite::storage_manager* storage) {
/*
...
bool Cluster3DParamsAna::finalize() {
/*
    if (_fout) {
        _fout->cd();
        for (auto & hist : startPointW) {
