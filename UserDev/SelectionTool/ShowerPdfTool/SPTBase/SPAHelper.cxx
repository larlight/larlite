...
namespace sptool {
  ...
  void SPAHelper::FillTracks ( const ::larlite::event_mctrack&  mct_v,
			       SPAData& res ) const
  {
  ...
  void SPAHelper::FillTracks ( const ::larlite::event_track&  trk_v,
			       ...
			       SPAData& res) const
  {
    // Fill tracks
    res._tracks.clear();
    res._tracks.reserve(trk_v.size());
  ...
  void SPAHelper::FillShowers ( const ::larlite::event_mcshower& mcs_v,
				SPAData& res ) const
  {
    // Fill showers
    res._showers.clear();
  ...
  void SPAHelper::FillShowers(const ::larlite::event_shower& shw_v,
  ...
  void SPAHelper::FillVertices( const ::larlite::event_vertex& vtx_v, 
				SPAData& res ) const
  ...
  void SPAHelper::FillVertices ( const::larlite::event_mctruth& mci_v,
				 SPAData& res) const
  {
    // Fill vertex
    ...
    for(auto const& mci : mci_v) {
      ...
      res._vtxs.clear();
      res._vtxs.reserve(mci.GetParticles().size());
