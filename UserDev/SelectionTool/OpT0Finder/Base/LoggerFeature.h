  ...
  */
  ...
  public:
    ...
    LoggerFeature(const std::string logger_name="LoggerFeature")
      : _logger(nullptr)
    { _logger = &(::flashana::logger::get(logger_name)); }
    ...
    /// Logger getter
    inline const flashana::logger& logger() const
    { return *_logger; }
    
    /// Verbosity level
    void set_verbosity(::flashana::msg::Level_t level)
    { _logger->set(level); }
  ...
  private:
    ...
    flashana::logger *_logger;   ///< logger
