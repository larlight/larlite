...
namespace flashana{
  ...
  void FlashHypo::QCluster(::geoalgo::Vector pt_1,
			   ::geoalgo::Vector pt_2,
  ...
  QCluster_t FlashHypo::FlashHypothesis(::geoalgo::Trajectory trj) const {
	...
	FlashHypo::QCluster(this_loc, last_loc, result);
      }
    }
    if(_end_bool){
      double length = 0;
