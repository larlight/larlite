...
FORMAT="\033[95mProduct\033[00m \"%10s \" (enum=%2d) ...\033[95m made by\033[00m %20s ...\033[95m count :\033[00m %d "
...
while mgr.next_event():
    ...
    for x in xrange(product_id_v.size()):
        ...
        if product_ptr :
            print FORMAT % (mgr.product_name(product_id.first),product_id.first,product_id.second,product_ptr.size())
